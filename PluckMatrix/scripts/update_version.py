...
def main():
  ...
  plistpath = scriptpath + "/resources/PluckMatrix-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PluckMatrix-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/PluckMatrix-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/PluckMatrix-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/PluckMatrix-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/PluckMatrix.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/PluckMatrix.iss",inplace=1):
