...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=PluckMatrix Demo Installer\n"
      else:
        line="OutputBaseFilename=PluckMatrix Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the PluckMatrix Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the PluckMatrix installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=PluckMatrix Demo installer\n"
     else:
       line="SetupWindowTitle=PluckMatrix installer\n"
