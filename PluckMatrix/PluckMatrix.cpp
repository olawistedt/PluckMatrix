...
#if IPLUG_DSP
void PluckMatrix::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void PluckMatrix::OnIdle()
{
  mMeterSender.TransmitData(*this);
  mLFOVisSender.TransmitData(*this);
}

void PluckMatrix::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
  mMeterSender.Reset(GetSampleRate());
}

void PluckMatrix::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void PluckMatrix::OnParamChange(int paramIdx)
{
  mDSP.SetParam(paramIdx, GetParam(paramIdx)->Value());
}

void PluckMatrix::OnParamChangeUI(int paramIdx, EParamSource source)
{
  #if IPLUG_EDITOR
...
bool PluckMatrix::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
